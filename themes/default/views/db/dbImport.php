...
<label>Max documents (lines) in chunk:</label> <input id="import_js_split_max" type="range" name="split_max" min="1" max="50000" step="1" value="5000"/><span id="split_max_value">5000</span><br/>
<script language="javascript">
